...
function MeetingEventList({ setSearchTerm, searchTerm }) {
            ...
            {filterdEventList.length > 0 ? (
                filterdEventList?.map((event) => (
                    <div className="border shadow-md border-t-8 border-[#FEBF30] p-5 m-3">
                        ...
                        <h2 className="font-bold text-2xl rounded-lg">
                            {event.meetingName}
                        </h2>
                        ...
                        <div>
                            <h2
                                ...
                                className="text-blue-500 flex mt-3 items-center gap-2 text-sm"
                            >
                                {" "}
                                <Copy /> Copy Link
                            </h2>
