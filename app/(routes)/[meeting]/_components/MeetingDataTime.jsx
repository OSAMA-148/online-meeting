        ...
        <div className="p-7 shadow-md   m-5 border-t-cyan-800 mx-10 md:mx-26 lg:mx-55 mt-20 ">
            ...
            <div className="mb-20 ">
                {step == 2 && (
                    <Button
                        onClick={() => setStep(1)}
                        className="float-right px-10 text-white  hover:bg-[#047772] transition-all cursor-pointer"
                    >
                        Back
                    </Button>
                )}
                {step == 1 ? (
                    <Button
                        ...
                        className="float-right px-10 mr-3 hover:bg-[#047772] transition-all text-white cursor-pointer"
                    >
                        Next
                    </Button>
                ) : (
