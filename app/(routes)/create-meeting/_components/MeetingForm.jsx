    ...
    return (
        <div className="p-4  ">
                ...
                <Button className="max-w-40 text-white">
                    <DropdownMenu className="bg-white ">
                        ...
                        <DropdownMenuContent className="bg-white border border-gray-200 shadow-lg rounded-md p-2 w-40">
                            <DropdownMenuItem onClick={(e) => setDuration(15)}>
                                15 Min
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={(e) => setDuration(30)}>
                                30 Min
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={(e) => setDuration(45)}>
                                45 Min
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={(e) => setDuration(60)}>
                                60 Min
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                ...
                <div className="grid grid-cols-3 gap-3">
                    {porgrams.map((item) => (
                        <div
                            ...
                            className={`cursor-pointer hover:bg-[#e8f7f6] border-slate-200 p-2 flex flex-col justify-center border items-center ${
            ...
            <Button
                ...
                className="mt-10 w-full text-white cursor-pointer"
            >
                Create
            </Button>
        </div>
